function prod = inverse_fisher_times_grad(b,c,grad,isotropic)
% compute the product inverse_fisher times grad for two cases: isotropic
% factor decompostion or rank-1 decomposition
% INPUT: 
...
% Author: Minh-Ngoc Tran (minh-ngoc.tran@sydney.edu.au)
% ============================================%
